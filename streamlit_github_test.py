# -*- coding: utf-8 -*-
"""
Created on Sun Feb 16 18:05:58 2025
...
def get_live_leaderboard(): 
    ...
    if response.status_code == 200:
        ...
        df_fanduel = fetch_github_csv("https://raw.githubusercontent.com/benpbooth/StatCaddy/refs/heads/main/genesis_invitational_odds.csv?token=GHSAT0AAAAAAC7AOGJ64XAMN3TI2PVL6RC4Z5SRP4Q")
...
def main():
    ...
    if not st.session_state["logged_in"]:
        ...
        if page == "Live Leaderboard":
            ...
            try:
                df_selected = fetch_github_csv("https://raw.githubusercontent.com/benpbooth/StatCaddy/8b253fef7f4af9f142c396ee00fc8b27931283ea/best_selected_players_genesis.csv?token=GHSAT0AAAAAAC7AOGJ6MKTFO2WYYV6LOCB4Z5SRPCA")
