...
def get_live_leaderboard(): 
    ...
    if response.status_code == 200:
        ...
        df_fanduel = fetch_github_csv("https://raw.githubusercontent.com/benpbooth/StatCaddy/main/genesis_invitational_odds.csv")
...
def main():
    ...
    if not st.session_state["logged_in"]:
        ...
        if page == "Live Leaderboard":
            ...
            try:
                df_selected = fetch_github_csv("https://raw.githubusercontent.com/benpbooth/StatCaddy/main/best_selected_players_genesis.csv")
